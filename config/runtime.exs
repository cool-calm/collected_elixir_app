...
#
#     PHX_SERVER=true bin/collected_public_data start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :collected_public_data, CollectedPublicDataWeb.Endpoint, server: true
end
...
if true do
  ...
  config :collected_public_data, CollectedPublicData.Repo,
...
if config_env() == :prod do
  ...
  config :collected_public_data, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :collected_public_data, CollectedPublicDataWeb.Endpoint,
  ...
  #
  #     config :collected_public_data, CollectedPublicData.Mailer,
